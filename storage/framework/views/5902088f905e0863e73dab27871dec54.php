...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'BMCODEX - Performance Without Limits'); ?></title>
    ...
    <header>
        <nav>
            ...
            <ul class="nav-links" id="navLinks">
                <li><a href="<?php echo e(route('home')); ?>">Strona główna</a></li>
                <li><a href="<?php echo e(route('products.index')); ?>">Produkty</a></li>
                
                <?php if(auth()->guard()->check()): ?>
                    <?php if(auth()->user()->isAdmin()): ?>
                        <li><a href="<?php echo e(route('admin.dashboard')); ?>">Panel Admin</a></li>
                    <?php endif; ?>
                    <li><a href="<?php echo e(route('favorites.index')); ?>">❤️ Ulubione</a></li>
                    <li><a href="<?php echo e(route('account')); ?>">Moje konto</a></li>
                    <li>
                ...
                <?php else: ?>
                    ...
                    <li><a href="<?php echo e(route('register')); ?>" class="btn btn-primary">Rejestracja</a></li>
                <?php endif; ?>
                
                <li class="cart-icon">
                    <a href="<?php echo e(route('cart.index')); ?>">🛒 Koszyk</a>
